$(document).ready(function() {
  ...
  function operateFormatter1(value, row, index) {
    return  [
              '<button id="deleteObs" data-toggle="modal" href="#deleteObsOnMedia" class="btn btn-xs btn-danger" value="'+value+'"><i class="glyphicon glyphicon-trash"></i></button>'
            ].join('');
  }
  ...
  $('#confdelete').click(function() {
    var id = $(this).val();
    var mm   = $(this).data('id_o');
    $.get('/admin/delObs/'+id, function(result){
      window.location.href="/admin/editMedia/"+mm;
    });
  });
////////////////////////////
