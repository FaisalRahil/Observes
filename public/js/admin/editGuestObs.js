$(document).ready(function() {
  ...
  $("[name='discount_flag']").on('switchChange.bootstrapSwitch', function (e, data) {
    $('#guestObs .editable').editable('toggleDisabled');
  });
  
  $('#pass_nid').editable({
    url: '/admin/editGuestObs_pass_nid/',
    type: 'text',
    pk: 1,
    name: 'pass_nid',
  ...
  $('#name_obs').editable({
    url: '/admin/editGuestObs_name_obs/',
    type: 'text',
    pk: 1,
    name: 'name_obs',
