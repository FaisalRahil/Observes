$(document).ready(function(){
  ...
  $('#typebtnNzip').on('click', function (e) {
    e.preventDefault();
    var isvalidate=$("#reportNzip").valid();
    if(isvalidate){
      var win = window.open("/reports/obsByTypezip/"+$('#obsByTypeNzip').val(), '_blank');
      win.focus();
    }
  });
  ...
  $('#orgbtnNzip').on('click', function (e) {
    e.preventDefault();
    var isvalidate=$("#norgformzip").valid();
    if(isvalidate){
      var win = window.open("/reports/orgObszip/"+$('#orgobsNzip').val(), '_blank');
      win.focus();
    }
  });
